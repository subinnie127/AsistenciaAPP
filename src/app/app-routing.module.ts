...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./pages/pregunta-incorrec/pregunta-incorrec.module').then( m => m.PreguntaIncorrecPageModule)
  },
  {
    path: 'respuestacorrecta',
    loadChildren: () => import('./pages/respuestacorrecta/respuestacorrecta.module').then( m => m.RespuestacorrectaPageModule)
  }
];
